  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden">
        <header className="h-16 bg-surface/50 border-b border-border flex items-center justify-between px-6 backdrop-blur-md">
          <div className="text-sm font-medium text-text-muted">{t('user.register')}: <span className="text-white font-bold">REG-01</span></div>
