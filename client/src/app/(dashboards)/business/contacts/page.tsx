...
export default function ContactsPage() {
  ...
  const fetchContacts = async () => {
    ...
    try {
      ...
      // fallback mock data for visually appealing demo
      setContacts([
        { id: 1, name: 'Alice Smith', type: 'customer', email: 'alice@example.com', mobile: '+1234567890' },
        { id: 2, name: 'Global Tech Supplies', type: 'supplier', email: 'contact@globaltech.com', mobile: '+9876543210' },
        { id: 3, name: 'Bob Jones', type: 'customer', email: 'bob@example.com', mobile: '+1122334455' },
      ]);
    } finally {
      setLoading(false);
    }
